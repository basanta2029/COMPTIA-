...
Replaces extractive summaries with Gemini-generated summaries optimized for RAG embeddings
"""
...
class ProcessingStats:
    ...
    def add_usage(self, input_tokens: int, output_tokens: int):
        ...
        input_cost = (input_tokens / 1_000_000) * 0.075  # $0.075 per million
        output_cost = (output_tokens / 1_000_000) * 0.30  # $0.30 per million

        self.total_cost += (input_cost + output_cost)


class GeminiSummarizer:
    """Generate AI-powered summaries using Gemini 2.5 Flash"""
...
Provide ONLY the summary. No preamble or explanations."""
    ...
    def run(self, clean_dir: Path, chapters: List[str] = None,
        ...
        print("=" * 60)
        print(f"Gemini AI Summary Generation - {mode}")
        print("=" * 60)
    ...
    def save_report(self, clean_dir: Path):
        ...
        report = {
            ...
            'cost_breakdown': {
                ...
                'input_cost': (self.stats.total_input_tokens / 1_000_000) * 0.075,
                'output_cost': (self.stats.total_output_tokens / 1_000_000) * 0.30,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Generate AI summaries using Gemini 2.5 Flash'
    )
    parser.add_argument(
        '--dry-run',
        action='store_true',
